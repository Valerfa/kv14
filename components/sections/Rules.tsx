...
const rules = [
  ...
  },
  {
    id: "equipment",
    title: "Оборудование",
    content: "В нашем пространстве качественный постоянный студийный свет Aputure Amaran Halo 200x. А так же насадки к нему: рефлектор, сфера, софтбокс с сотами. \n Черный бумажный фон на стойках 700р на все время аренды. \n Белая ткань на стойке входит в стоимость аренды. \n  Отпариватель доступен по запросу и входит в стоимость аренды",
  },
  {
    id: "people",
  ...
  },
  {
    ...
    content: "Мы с радостью принимаем гостей с питомцами 🐾. \n Пожалуйста, предупредите нас заранее при бронировании. \n Доплата за съёмку с животными — 500 ₽",
  },
                      ...
                      {openId === rule.id && (
                        ...
                        >
                          <div className="pl-7 md:pl-10 lg:pl-12 xl:pl-14 2xl:pl-16 pb-5 text-body text-foreground text-left">
                            <div className="w-full lg:w-1/2 whitespace-pre-line">
                              {rule.content}
                            </div>
                          </div>
                        </motion.div>
