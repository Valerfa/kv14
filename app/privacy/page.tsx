            ...
            <FadeIn>
              ...
              <div className="text-body space-y-4 text-left">
                ...
                <p className="text-body mb-6">
                  1.1. Настоящая Политика обработки персональных данных (далее — Политика) определяет порядок обработки и меры по обеспечению безопасности персональных данных, предпринимаемые Индивидуальным предпринимателем Лютиковой Анной Николаевной (далее — Оператор).
                </p>
                <p className="text-body mb-6">
                ...
                <p className="text-body mb-6">
                  ...
                  <br />— исполнения договорных обязательств (публичной оферты)
                ...
                <p className="text-body mb-6">
                  6.2. Оператор принимает необходимые правовые, организационные и технические меры для защиты персональных данных от неправомерного доступа, уничтожения, изменения, блокирования и иных неправомерных действий.
                </p>
                <p className="text-body mb-6">
                  6.3. Персональные данные хранятся не дольше, чем этого требуют цели обработки или законодательство Российской Федерации.
                </p>
                ...
                <p className="text-body mb-6">
                  7.2. Для организации онлайн-бронирования используется сервис онлайн-бронирования, предоставляемый ООО «Квик Букинг Платформ».
                  <br />
                ...
                <p className="text-body mb-6">
                  7.3. При оплате услуг персональные данные могут передаваться платежным сервисам, включая ООО НКО «ЮМани», обеспечивающим прием и обработку платежей.
                </p>
                <p className="text-body mb-6">
                  7.4. Передача персональных данных осуществляется только в объеме, необходимом для достижения целей обработки.
                </p>
                <p className="text-body mb-6">
                  7.5. Третьи лица обязуются соблюдать конфиденциальность и обеспечивать безопасность персональных данных в соответствии с применимым законодательством.
                </p>

                <h2 className="font-[var(--font-unbounded)] text-xl font-medium mt-10 mb-4">
                  8. Обработка с использованием интернет-сервисов
                </h2>
                <p className="text-body mb-6">
                  8.1. При использовании сторонних сервисов обработка персональных данных может осуществляться с использованием серверов, расположенных за пределами Российской Федерации.
                </p>
                <p className="text-body mb-6">
                  8.2. Обработка персональных данных такими сервисами осуществляется в соответствии с их собственными условиями и политиками конфиденциальности.
                </p>
                ...
                <p className="text-body mb-6">
                  ...
                  <br />— требовать уточнения, блокирования или удаления персональных данных
                ...
                <p className="text-body mb-6">
                  10.1. Пользователь может направить запрос по вопросам обработки персональных данных на email Оператора: anna.marinina00@mail.ru
                </p>
                <p className="text-body mt-12 pt-8 border-t">
                  10.2. Актуальная версия Политики размещается на сайте и доступна для ознакомления в любое время.
                </p>
              </div>
              </div>
            </FadeIn>
